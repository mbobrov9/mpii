...
public class RequestcicleTest {
  ...
  public void requestcicle() {
    ...
    driver.findElement(By.linkText("Вызов оцилопа")).click();
    driver.findElement(By.name("type")).click();
    {
      WebElement dropdown = driver.findElement(By.name("type"));
      dropdown.findElement(By.xpath("//option[. = 'Новый закон']")).click();
    }
    driver.findElement(By.name("type")).click();
    ...
    {
      WebElement dropdown = driver.findElement(By.name("type"));
      dropdown.findElement(By.xpath("//option[. = 'Цик']")).click();
    }
